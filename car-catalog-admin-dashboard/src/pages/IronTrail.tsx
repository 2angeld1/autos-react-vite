                ...
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold text-gray-900 flex items-center gap-3">
                            <motion.div 
                                variants={scaleIn} 
                                className="p-2 bg-gradient-to-br from-amber-500 to-orange-600 rounded-xl text-white"
                            >
                                <Mountain className="h-7 w-7" />
                            </motion.div>
                            IronTrail Products
                        </h1>
                        <p className="text-gray-500 mt-1">Gestiona suspensiones, accesorios 4x4 y equipamiento off-road</p>
                    </div>
                    <Button
                        variant="primary"
